...
### 💻 Desarrollador Full Stack | Enfoque en Análisis de Datos con Python

Soy estudiante de **Ingeniería de Sistemas y Computación** en la **Universidad Tecnológica de Pereira**. Mi principal fortaleza es el **Desarrollo Web (JavaScript/TypeScript)**, con experiencia en la construcción de aplicaciones modernas.

Paralelamente, poseo conocimientos en **Python** aplicados a proyectos pequeños con librerías de análisis de datos como **NumPy** y **Pandas**. Me destaco por mi capacidad de adaptación, compromiso con la calidad del código y estoy siempre dispuesto a enfrentar nuevos retos y aprender nuevas tecnologías.
